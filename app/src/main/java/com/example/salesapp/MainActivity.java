...
public class MainActivity extends AppCompatActivity {
    ...
    private CardView prev_Invoice, orders, add_Customer, assign_sales_rep, connect_Printer, searchCustomers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchCustomers = (CardView) findViewById(R.id.search_customers);
        ...
        connect_Printer = (CardView) findViewById(R.id.connect_Printer);
        searchCustomers = findViewById(R.id.search_customers);
        ...
        searchCustomers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = getIntent();
                String mobId = intent.getStringExtra("MOB_ID");
                Intent intent1 = new Intent(getApplicationContext(),SearchCustomers.class);
        ...
        connect_Printer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = getIntent();
                String mobId = intent.getStringExtra("MOB_ID");
                Intent intent1 = new Intent(getApplicationContext(),ConnectPrinter.class);
                intent1.putExtra("MOB_ID",mobId);
                startActivity(intent1);
            }
        });
